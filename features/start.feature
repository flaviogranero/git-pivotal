Feature: git start
  ...
  Scenario: Starting the next chore when it is unestimated
    ...
    Then the output should contain "Switched to a new branch 'PIVOTAL_USERNAME.CURRENT_CARD.a_chore'"
    And I should be on the "PIVOTAL_USERNAME.CURRENT_CARD.a_chore" branch
  ...
  Scenario: Starting the next bug when it is unestimated
    ...
    Then the output should contain "Switched to a new branch 'PIVOTAL_USERNAME.CURRENT_CARD.a_bug'"
    And I should be on the "PIVOTAL_USERNAME.CURRENT_CARD.a_bug" branch
    And card CURRENT_CARD is marked is started in Pivotal Tracker
  ...
  Scenario Outline: Starting the next estimated card using configured defaults (with -D option)
    ...
    Then the output should contain "Switched to a new branch 'PIVOTAL_USERNAME.CURRENT_CARD.a_<card_type>'"
    And I should be on the "PIVOTAL_USERNAME.CURRENT_CARD.a_<card_type>" branch
    And card CURRENT_CARD is marked is started in Pivotal Tracker
